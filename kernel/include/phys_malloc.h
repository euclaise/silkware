/*
  ...
  last update: Sun Feb 25 18:38:11 2001  Doug Lea  (phys_ at gee)
  ...
  * If USE_DL_PREFIX is defined, it is assumed that malloc.c 
    ...
    have names starting with "phys_".
...
void*  phys_calloc(size_t, size_t);
...
void*  phys_memalign(size_t, size_t);
...
void** phys_independent_calloc(size_t, size_t, void**);
...
void** phys_independent_comalloc(size_t, size_t*, void**);
...
size_t   phys_malloc_usable_size(void*);
...
struct mallinfo phys_mallinfo(void);
...
/*
  ...
  enables future requests for chunks of the same size to be hanphys_ed
  ...
  strings -- the default hanphys_es structs/objects/arrays with sizes up
...
/*
  ...
  * When malloc_trim is called automatically from free(),
  ...
  after trimming) will invoke sbrk, which neephys_essly wastes
  time.
