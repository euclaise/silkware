...
#define public_cALLOc    phys_calloc
#define public_fREe      phys_free
#define public_cFREe     phys_cfree
#define public_mALLOc    phys_malloc
#define public_mEMALIGn  phys_memalign
#define public_rEALLOc   phys_realloc
#define public_vALLOc    phys_valloc
#define public_pVALLOc   phys_pvalloc
#define public_mALLINFo  phys_mallinfo
#define public_mALLOPt   phys_mallopt
#define public_mTRIm     phys_malloc_trim
#define public_mSTATs    phys_malloc_stats
#define public_mUSABLe   phys_malloc_usable_size
#define public_iCALLOc   phys_independent_calloc
#define public_iCOMALLOc phys_independent_comalloc
...
#include <stdint.h>
extern void *phys_sbrk(intptr_t);
